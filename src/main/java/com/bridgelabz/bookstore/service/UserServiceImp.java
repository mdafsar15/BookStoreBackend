...
import com.bridgelabz.bookstore.repo.ImageRepository;
...
//	}
	...
	public String uploadFile(MultipartFile file, String token) throws Exception {
		...
		imageRepository.addImage(Image.builder().name(file.getOriginalFilename()).type(file.getContentType())
	...
	public byte[] getImage(Long id) {
		Image dbImage = imageRepository.findByName(id);
		byte[] image = ImageUtil.decompressImage(dbImage.getImage());
		return image;
	}
